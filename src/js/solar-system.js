...
import mercurryTexture from "../img/mercury.jpg";
...
const mercurry = createPlanete(3.2, mercurryTexture, 28);
...
const pointLight = new THREE.PointLight(0xfffffff, 2, 300);
scene.add(pointLight);

function animate() {
  // Seft-rotation
  sun.rotateY(0.004);
  mercurry.mesh.rotateY(0.004);
