...
import mountain from "../img/mountain.avif";
...
const texture = loader.load([star2, star2, star2, star2, star2, star2]);
...
const box2MultiMaterial = [
  ...
  new THREE.MeshBasicMaterial({ map: textureLoader.load(stars) }),
  new THREE.MeshBasicMaterial({ map: textureLoader.load(mountain) }),
  new THREE.MeshBasicMaterial({ map: textureLoader.load(stars) }),
  new THREE.MeshBasicMaterial({ map: textureLoader.load(mountain) }),
  new THREE.MeshBasicMaterial({ map: textureLoader.load(stars) }),
];
...
// box2.material.map = textureLoader.load(mountain);
